...
curl -o- https://gitlab.gnome.org/api/v4/projects/665/repository/tags?search=^4.4 > _data/api_fetch/stable_tags.json
curl -o- https://gitlab.gnome.org/api/v4/projects/665/repository/tags?search=^4.5 > _data/api_fetch/unstable_tags.json
